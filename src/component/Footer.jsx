...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".1" className=" bg-zinc-900 w-full h-[120vh] pt-[10vw] px-10  rounded-tl-3xl  rounded-tr-3xl">
      <div className=" w-full h-full  flex">
        <div className="h-full relative w-1/2 ">
          <div className=" FooterHeading text-[9vw] uppercase leading-[7vw] ">
            <h1>eye-</h1>
            <h1> opening</h1>
          </div>
        ...
        <div className="h-full w-1/2 ">
          ...
          <div className=" content capitalize w-full   flex flex-col gap-10 pt-[7vw]">
            ...
            <div className="w-full  flex gap-[30vw] items-start">
              <div className=" ">
                <h4>L:</h4>
                <div className="flex flex-col gap-5 w-[11vw]">
                  <p>202-1965 W 4th Ave Vancouver, Canada</p>
                  <p>30 Chukarina St Lviv, Ukraine</p>
                </div>
              </div>
